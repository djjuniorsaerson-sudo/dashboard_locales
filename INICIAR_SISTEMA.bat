...
start "Backend - Panel Central" cmd /k "cd backend & call venv\Scripts\activate.bat & python create_db.py & python create_admin.py & uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload"
